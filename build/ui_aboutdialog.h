...
"Copyright &copy; 2011-YYYY The MKTCoins developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MKTCoins", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>MKTCoins</b> version", 0));
